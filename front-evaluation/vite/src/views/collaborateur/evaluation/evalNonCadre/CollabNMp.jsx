...
function ManagerNMp() {
  ...
  const validateMidtermObjectifHistory = async () => {
    try {
      ...
      // Supprimer la vérification de signature
      // if (!signatureFile) {
      ...
      // Supprimer la comparaison de signature
                  ...
                  <CardContent>
                    <Accordion>
                      ...
                      <AccordionSummary
                        ...
                        id={`panel-${comp.competenceId}-header`} sx={{backgroundColor:'#80808014'}}
                      >
